<template>
  <div>
      ...
      <div class="cart">
        ...
        <div class="item-list-wrap">
          <div class="cart-item">
            ...
            <ul class="cart-item-list" id="cartList">
    ...
    <Modal v-bind:mdShow="modalConfirm" @close="closeModel">
...
export default {
  ...
  methods: {
    ...
    delCart(item, index) {
      ...
      console.log(item);
      //   let ind = this.cartList.findIndex((value, index, arr) => {
      ...
      axios
        ...
        .then(Response => {
          let res = Response.data;
          if (res.code == 200) {
            // var delCount = this.item.productNum;
